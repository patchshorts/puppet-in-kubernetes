...
| R10K_CONTROL_REPO      | r10k control repository containing Puppetfile                   | -                    |
| R10K_HIERA_REPO        | r10k hiera repository                                           | -                    |
...
environment variables `R10K_CONTROL_REPO` AND `R10K_HIERA_REPO` is therefore mandatory.
...
```
  ...
  r10k:
    volumes:
      - r10k_env:/etc/puppetlabs/code/environments/
      - r10k_hie:/etc/puppetlabs/hieradata/
```
